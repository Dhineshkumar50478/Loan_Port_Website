...
export default function AdminLogin() {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post("https://loan-fy-server-git-main-dhineshkumars-projects.vercel.app/api/admin/send-otp", { email });
      setOtpSent(true);
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://loan-fy-server-git-main-dhineshkumars-projects.vercel.app/api/admin/verify-otp", {
        email,
        otp,
      });
